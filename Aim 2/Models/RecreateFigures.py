# -*- coding: utf-8 -*-
"""
Created on Tue Sep 28 18:16:23 2021
...
"""
Sample:  Recreate RF Top 20 plot
"""
...
def featureRankGLMrecreate(filename, X_train, y_train):
    """
...
def featureRankingRFrecreate(filename1, filename2, X_train):
    """
...
filename = 'S:/Dehydration_stroke/Team Emerald/Working GitHub Directories/'\
           'Michael/stroke-hemodynamics/Aim 2/Models/FullModelResults/UpdatedResults/TEST_GLM_Features_24.sav'
nznew, fig, ax = featureRankGLMrecreate(filename, X_train, y_train)
...
filename1 = 'S:/Dehydration_stroke/Team Emerald/Working GitHub Directories/'\
           'Michael/stroke-hemodynamics/Aim 2/Models/FullModelResults/UpdatedResults/TEST_RF_Features_24_1.sav'
filename2 = 'S:/Dehydration_stroke/Team Emerald/Working GitHub Directories/'\
           'Michael/stroke-hemodynamics/Aim 2/Models/FullModelResults/UpdatedResults/TEST_RF_Features_24_2.sav'
sfm, fig, ax = featureRankingRFrecreate(filename1, filename2, X_train)
...
fig.savefig('S:/Dehydration_stroke/Team Emerald/Working GitHub Directories/'\
            'Michael/stroke-hemodynamics/Aim 2/Models/FullModelResults/UpdatedResults/PaperFigure1.png',
            dpi=800)
...
# Perform GLM feature ranking
filename = 'S:/Dehydration_stroke/Team Emerald/Working GitHub Directories/'\
           'Michael/stroke-hemodynamics/Aim 2/Models/FullModelResults/UpdatedResults/TEST_GLM_Features_48.sav'
nznew, fig, ax = featureRankGLMrecreate(filename, X_train, y_train)
...
# Perform RF feature ranking
filename1 = 'S:/Dehydration_stroke/Team Emerald/Working GitHub Directories/'\
           'Michael/stroke-hemodynamics/Aim 2/Models/FullModelResults/UpdatedResults/TEST_RF_Features_48_1.sav'
filename2 = 'S:/Dehydration_stroke/Team Emerald/Working GitHub Directories/'\
           'Michael/stroke-hemodynamics/Aim 2/Models/FullModelResults/UpdatedResults/TEST_RF_Features_48_2.sav'
sfm, fig, ax = featureRankingRFrecreate(filename1, filename2, X_train)
...
# Perform GLM feature ranking
filename = 'S:/Dehydration_stroke/Team Emerald/Working GitHub Directories/'\
           'Michael/stroke-hemodynamics/Aim 2/Models/FullModelResults/UpdatedResults/TEST_GLM_Features_72.sav'
nznew, fig, ax = featureRankGLMrecreate(filename, X_train, y_train)
...
# Perform RF feature ranking
filename1 = 'S:/Dehydration_stroke/Team Emerald/Working GitHub Directories/'\
           'Michael/stroke-hemodynamics/Aim 2/Models/FullModelResults/UpdatedResults/TEST_RF_Features_72_1.sav'
filename2 = 'S:/Dehydration_stroke/Team Emerald/Working GitHub Directories/'\
           'Michael/stroke-hemodynamics/Aim 2/Models/FullModelResults/UpdatedResults/TEST_RF_Features_72_2.sav'
sfm, fig, ax = featureRankingRFrecreate(filename1, filename2, X_train)
...
fig.savefig('S:/Dehydration_stroke/Team Emerald/Working GitHub Directories/'\
           'Michael/stroke-hemodynamics/Aim 2/Models/FullModelResults/UpdatedResults/PaperFigure2.png',
            dpi=800)